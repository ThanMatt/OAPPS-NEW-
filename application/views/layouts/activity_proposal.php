      ...
      <div class="container-proposal-activity">
        ...
        <div class="content-container-proposal-activity">
          ...
          <div class="radio-container-proposal">
            <div class="radio-subcontainer-proposal-1">
              ...
              <div id="collab-container" hidden>
                Partner/s: <input type="text" class="field_ap" name="specified_co_curric" id="partner_collab" value="<?=$record->Partners?>" disabled>
              </div>
            </div>
            ...
            <div class="radio-subcontainer-proposal-2">
              ...
              <div class="rd-non-academic-container" hidden>
                ...
                <div id="co-curricular" hidden>
                  Specified: <input type="text" name="specified_co_curric" class="non_acad" id="specified_co" value="<?=$record->Specified?>" disabled>
                </div>
                ...
                <div id="extra-curricular" hidden>
                  Specified: <input type="text" name="specified_ex_curric" class="non_acad" id="specified_ex" value="<?=$record->Specified?>" disabled>
                </div>
          ...
          <div class="button-container-proposal">
            ...
            <a href="delete/<?=$record->Proposal_ID?>">
