<?php
    ...
    $pdf->SetY('81');
    $pdf->SetX('22');
    $pdf->Cell(55, 5,'Tissues', 1, 0,'C');

    // Item - Table Header - Cell Text
    $pdf->Cell(80, 0,''); //Positioning Cell
    $pdf->SetY('81');
    $pdf->SetX('77');
    $pdf->Cell(27, 5,'2', 1, 0,'C');

    // Item - Table Header - Cell Text
    $pdf->Cell(80, 0,''); //Positioning Cell
    $pdf->SetY('81');
    $pdf->SetX('104');
    $pdf->Cell(27, 5,'40', 1, 0,'C');

    // Item - Table Header - Cell Text
    $pdf->Cell(80, 0,''); //Positioning Cell
    $pdf->SetY('81');
    $pdf->SetX('131');
    $pdf->Cell(27, 5,'80', 1, 0,'C');

    // Item - Table Header - Cell Text
    $pdf->Cell(80, 0,''); //Positioning Cell
    $pdf->SetY('81');
    $pdf->SetX('158');
    $pdf->Cell(40, 5,'Somewhere', 1, 0,'C');
    ...
    $pdf->SetY('90');
    $pdf->SetX('22');
    $pdf->Cell(176, 5,'FAR SUB TOTAL: PHP 10000', 1, 0,'C');
    ...
    $pdf->SetX('22');
    $pdf->Cell(176, 5,'OE SUB TOTAL: PHP 10000', 1, 0,'C');
    ...
    $pdf->SetX('22');
    $pdf->Cell(176, 8,'TOTAL: PHP 20000', 1, 0,'C');
